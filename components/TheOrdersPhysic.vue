<template>
  <div class="orders-physic">
    <base-page-map to="/orders" name="naturalEntity"></base-page-map>
    <base-title class="orders-physic__title" title="orders"></base-title>
    <h3 class="orders-physic__subtitle">{{ $t('naturalEntity') }}</h3>
    <div class="orders-physic__form-wrapper">
      <form class="orders-physic__form" @submit.prevent>
        <div class="orders-physic__row">
          <base-input
            label="Familiýaňyz, adyňyz"
        ...
        <div class="orders-physic__textarea-wrapper">
          <base-textarea
            label="Bellik"
...
export default {
  ...
  methods: {
    ...
    async add() {
      if (
        !this.main.name ||
        !this.main.from_where ||
        !this.main.number ||
        !this.main.to_where ||
        !this.main.email ||
        !this.main.stuff_type ||
        !this.main.car_date ||
        !this.main.stuff_weight ||
        !this.main.note
      ) {
